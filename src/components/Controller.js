    ...
    render () {
        return(
            <div className="controller">
                ...
                <button className='bfs' onClick={this.drawGenerate}>bfs</button>
				<button className='dfs' onClick={this.drawGenerate}>dfs</button>
				<button className='reset'>reset</button>
{/*                 
                <TreeTraversal 
                onClickBFS={this.draw}
                onClickDFS={this.draw}
                /> */}
            </div>
        );
    }
